...
To initialize your local repository using the OMNIROM trees to build TWRP, use a command like this:
    ...
    repo init -u https://github.com/Android4Lumia950/platform_manifest_twrp_omni.git -b twrp-6.0
    
To initialize a shallow clone, which will save even more space, use a command like this:

    repo init --depth=1 -u https://github.com/Android4Lumia950/platform_manifest_twrp_omni.git -b twrp-6.0
